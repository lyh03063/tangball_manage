...
export default {
  ...
  created() {
    ...
    //id是自增
    this.arrPerson = [{ id: "1", "name": "张三" }, { id: "2", "name": "李四" }, { id: "4", "name": "大明" }]
    //赛事数组
    this.arrMatch = [{ id: 1, matchName: "赛事1", personId: "1" }, { id: 2, matchName: "赛事2", personId: "4" }]


    /**为第三种方式准备 */
    this.dictPerson = {};//人员数据字典对象
    this.arrPerson.forEach(personEach => {//循环：{人员数组}
    ...
    this.arrMatch.forEach(matchEach => {//循环：{赛事数组}
