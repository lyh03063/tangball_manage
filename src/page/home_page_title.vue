<template>
  <div class>
    ...
    <div class="PT10 PL10">
      小程序页面链接说明(xxx要替换成对应的数据id)：
      <br />赛事详情地址：/pages/matchDetail/main?id=xxx
      <br />资讯详情地址：/pages/articleDetail/main?dataId=xxx
    </div>
    ...
    <div class="TitleMsg-box">
      ...
      <div>
        <div style="flex:0 0 100px;">是否显示：</div>
        <el-radio v-model="TitleMsg.show" :label="1">显示</el-radio>
        <el-radio v-model="TitleMsg.show" :label="2">隐藏</el-radio>
      </div>

      <div>
        <div style="flex:0 0 100px;">大标题：</div>
        <el-input
          v-model="TitleMsg.bigTitle"
          placeholder="请输入内容"
...
export default {
  ...
  methods: {
    async getTitleMsg() {
      ...
      this.TitleMsg.show=this.TitleMsg.show||1;
    },
