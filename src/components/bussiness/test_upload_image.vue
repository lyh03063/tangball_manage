...
<template>
    <div class="avatar">
        <div @mouseover="showBg=true" @mouseleave="showBg=false">
            <div class="bg" v-if="showBg" :style="`line-height:${imgHeight}`">点击上传111</div>
          ...
          console.log("changeImage-1");
            ...
            if(file) {
                ...
                reader.readAsDataURL(file)
                 console.log("changeImage-2");
                reader.οnlοad= function(e){
                   console.log("changeImage-3");
                    // 这里的this 指向reader
                    that.avatar = this.result
                }
                 reader.onerror= function(e){
                   console.log("changeImage-4");
